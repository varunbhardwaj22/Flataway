...
public class LocationTakerActivity extends AppCompatActivity {
	...
	protected void onCreate(Bundle _savedInstanceState) {
		...
		setContentView(R.layout.location_taker);
	...
	private void initializeLogic() {
		if (ContextCompat.checkSelfPermission(LocationTakerActivity.this, Manifest.permission.ACCESS_FINE_LOCATION) == PackageManager.PERMISSION_GRANTED) {
